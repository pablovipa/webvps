...
const navigation = {
  solutions: [
    ...
    { name: 'Comercio', href: '#' },
    { name: 'Costos', href: '#' },
    <span id="siteseal"><script async type="text/javascript" src="https://seal.starfieldtech.com/getSeal?sealID=zriTVcqoPDalv6QQqJo1UOYc7iw7xTrMwk4A95N58dueMnf0CxS0gUV6WAIC"></script></span>
  ],
  support: [
    { name: 'Precios', href: '#' },
    { name: 'Documentacion', href: '#' },
    { name: 'Guia', href: '#' },
    { name: 'Estado de la API', href: '#' },
  ],
  company: [
    { name: 'Acerca de', href: '#' },
    { name: 'Blog', href: '#' },
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="grid grid-cols-2 gap-8 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-12 md:mt-0">
                <h3 className="text-sm font-semibold text-gray-400 tracking-wider uppercase">Sopote</h3>
                <ul role="list" className="mt-4 space-y-4">
          ...
          <div className="mt-8 xl:mt-0">
            <h3 className="text-sm font-semibold text-gray-400 tracking-wider uppercase">
              Subscribete a nuestros promociones y campañas
            </h3>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
            &copy; 2023 VITEXI, Inc. Todos los derechos reservados.
          </p>
        <span id="siteseal"><script async type="text/javascript" src="https://seal.starfieldtech.com/getSeal?sealID=zriTVcqoPDalv6QQqJo1UOYc7iw7xTrMwk4A95N58dueMnf0CxS0gUV6WAIC"></script></span> 
